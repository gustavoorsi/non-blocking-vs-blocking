...
class DemoTestNonBlocking extends Simulation {
  ...
  val requestName  = baseName + "-non-blocking-request"
  val scenarioName = baseName + "-non-blocking-scenario"
  val URI          = baseURL + "/demo/nonBlocking"
